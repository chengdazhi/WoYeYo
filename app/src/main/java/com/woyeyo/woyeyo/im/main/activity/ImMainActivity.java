 ...
 */
public class ImMainActivity extends TActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!syncCompleted) {
            DialogMaker.showProgressDialog(ImMainActivity.this, getString(R.string.prepare_data)).setCanceledOnTouchOutside(false);
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.about:
                startActivity(new Intent(ImMainActivity.this, SettingsActivity.class));
                break;
            case R.id.create_normal_team:
                ContactSelectActivity.Option option = TeamHelper.getCreateContactSelectOption(null, 50);
                NimUIKit.startContactSelect(ImMainActivity.this, option, REQUEST_CODE_NORMAL);
                break;
            case R.id.create_regular_team:
                ContactSelectActivity.Option advancedOption = TeamHelper.getCreateContactSelectOption(null, 50);
                NimUIKit.startContactSelect(ImMainActivity.this, advancedOption, REQUEST_CODE_ADVANCED);
                break;
            case R.id.search_advanced_team:
                AdvancedTeamSearchActivity.start(ImMainActivity.this);
                break;
            case R.id.add_buddy:
                AddFriendActivity.start(ImMainActivity.this);
                break;
            case R.id.search_btn:
                GlobalSearchActivity.start(ImMainActivity.this);
                break;
            default:
                break;
        }
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CODE_NORMAL) {
                ...
                if (selected != null && !selected.isEmpty()) {
                    TeamCreateHelper.createNormalTeam(ImMainActivity.this, selected, false, null);
                } else {
                    Toast.makeText(ImMainActivity.this, "请选择至少一个联系人！", Toast.LENGTH_SHORT).show();
                }
            } else if (requestCode == REQUEST_CODE_ADVANCED) {
                final ArrayList<String> selected = data.getStringArrayListExtra(ContactSelectActivity.RESULT_DATA);
                TeamCreateHelper.createAdvancedTeam(ImMainActivity.this, selected);
            }
        }
